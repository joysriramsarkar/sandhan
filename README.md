...
**সন্ধান (Sandhan)** একটি উন্মুক্ত, সার্বজনীন ও গোপনীয়তা-প্রথম সার্চ ইঞ্জিন — **[sandhan.site](https://sandhan.site)**। এটি সমগ্র বিশ্বব্রহ্মাণ্ডের কোটি কোটি ওয়েবসাইট, উইকি, ব্লগ ও নিউজ পোর্টাল থেকে তাৎক্ষণিক ফলাফল খুঁজে আনে, ব্যবহারকারীর সার্চ হিস্টরি ক্লায়েন্ট-সাইডে ক্রিপ্টোগ্রাফিকভাবে এনক্রিপ্ট রাখে এবং সম্পূর্ণ স্বচ্ছ র‍্যাংকিং প্রদান করে।
